...
def parse_arguments():
    ...
    parser.add_argument('--cache_path', type=str, default='bert_config/bert-base-uncased', help="The caching directory for pre-trained models.")   
...
def run(args, debug_args=None):
    ...
    if not args.train:
        ...
        #exit()
        args.model_output_path='./outputs/misa_t_a_MIntRec_multi-class_2025-09-30-11-16-16/models'
        print(args.model_output_path)
    ...
    data = DataManager(args) #data
    method_manager = method_map[args.method]
    print(method_manager)
    print(args)
    #exit()
