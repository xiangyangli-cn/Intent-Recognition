...
class DataManager:
    ...
    def __init__(self, args, logger_name = 'Multimodal Intent Recognition'):
        ...
        print(os.path.join(self.data_path, 'train.tsv'))
        #exit(0)
        ...
        print(self.benchmarks['feat_dims']['text'])
        #exit()
    ...
    def _get_indexes_annotations(self, read_file_path, data_mode):
        ...
        print(label_map)
        #exit()
        #label_map={'安全提示': 0, '操作指引': 1, '风险提示': 2, '紧急处置': 3, '协作分工': 4}
