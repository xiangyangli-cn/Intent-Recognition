...
class TextDataset:
    ...
    def _get_bert_feats(self, args, examples, base_attrs):
        ...
        if args.text_backbone.startswith('bert'):
            tokenizer = BertTokenizer.from_pretrained('./bert_config/bert-base-chinese', do_lower_case=True)   
    ...
    def _read_tsv(cls, input_file, quotechar=None):
        ...
        with open(input_file, "r") as f:
            ...
            for line in reader:
                ...
                lines.append(line)
            #print(lines) #['S06', 'E03', '458', 'glenn gave me ultimate executive power.', 'Flaunt']
            #exit()
            print(len(lines))
            #exit()
            return lines
